...
export default class Recipe extends Component {
  render() {
    ...
    return (
      <React.Fragment >
        <div className="col-10 mx-auto col-md-6 text-uppercase col-lg-4 my-3">
            <div className="card">
                ...
                <div className="card-footer">
                   ...
                   /* onClick={handleDetails} */
                    ...
                    >Details</button>
                    <a href={source_url} className="btn btn-success mx-2 text-capitalize" target="_blank" rel="noopener noreferrer">Recipe Link</a>
                </div>
            </div>
        </div>
